jQuery(function($) {
  ...
  new Chart(ctx, {
      type: 'line',
      data: {
        labels: ["Ene", "Feb", "Mar", "Abr", "May", "June", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"],
        datasets: [{
          label: "Instagram",
          data : [5000, 1500, 3500, 2500, 3200, 7000, 2300, 3500, 3500, 6000, 6200, 8100],
        ...
        {
          label: "Prueba",
          data: [1500, 3200, 3000, 1213, 3510, 4800, 1212, 5900, 6656, 7878, 3332, 5151],
          ...
          pointHoverBorderColor: '#3379FF',
          pointHoverBackgroundColor: '#3379FF',
